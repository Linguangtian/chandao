                    ...
                    try {
                        ...
                        if(response.result === 'success') {
                            if(response.message) {
                                ...
                                if(response.locate) {
                                    var locateUrl = response.locate == 'reload' ? location.href : response.locate;
                                    setTimeout(function(){location.href = locateUrl;}, 1200);
                                }
                            } else {
                                if(response.locate) location.href = (response.locate == 'reload' ? location.href : response.locate);
                            }
                        } else {
