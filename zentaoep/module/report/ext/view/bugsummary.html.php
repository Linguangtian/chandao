         ...
         <form method='post'>
          ...
          <div class='col-sm-5'>
              <div class='input-group input-group-sm'>
                <span class='input-group-addon'><?php echo $lang->report->bugResolvedDate;?></span>
        ...
        <div data-ride='table'>
          <table class='table table-condensed table-striped table-bordered table-fixed' id="bugsummary">
            <thead>
              ...
              <th class="w-90px"><?php echo $lang->bug->resolvedDate;?></th>
            ...
            <tbody>
              ...
              <tr class="text-center">
                ...
                <?php if($id != 0) echo "<tr class='text-center'>"?>
                  ...
                  <td><?php echo substr($bug->resolvedDate, 0, 10);?></td>
