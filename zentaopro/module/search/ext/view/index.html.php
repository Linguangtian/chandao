  ...
  <div class='col-md-12'>
    <form method='post' action='<?php echo inlink('index')?>' style='margin-bottom:10px;'>
      <div class='input-group col-md-8 col-md-offset-2'>
        ...
        <span class='input-group-btn select w-100px'><?php echo html::select('type', $lang->search->modules, $type, "class='form-control chosen'")?></span>
