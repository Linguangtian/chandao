...
$lang->project->subMenu->action->effort = 'Calendar|project|effortcalendar|projectID=%s';

$lang->company->menu->effort  = array('link' => 'Calendar|company|calendar|', 'alias' => 'effort');
...
$lang->my->menu->calendar = array('link' => 'Calendar|my|calendar|', 'subModule' => 'todo,effort', 'alias' => 'todo', 'class' => 'dropdown dropdown-hover');

$lang->my->subMenu = new stdclass();
$lang->my->subMenu->calendar = new stdclass();
$lang->my->subMenu->calendar->todo   = 'Todo|todo|calendar|';
$lang->my->subMenu->calendar->effort = 'Effort|effort|calendar|';