...
<div id="mainMenu" class="clearfix">
  <div class="btn-toolbar pull-left">
    ...
    echo html::a(inlink('task', "type=urgentJob"),  "<span class='text'>紧急任务</span>" . ($type == 'urgentJob' ? $recTotalLabel : ''), '', "class='btn btn-link" . ($type == 'urgentJob' ? ' btn-active-text' : '') . "'");
    echo html::a(inlink('task', "type=tomorrowJob"),  "<span class='text'>明日任务</span>" . ($type == 'tomorrowJob' ? $recTotalLabel : ''), '', "class='btn btn-link" . ($type == 'tomorrowJob' ? ' btn-active-text' : '') . "'");
    ?>
  </div>
</div>
<div id="mainContent">
